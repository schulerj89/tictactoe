  ...
  constructor({ baseUrl = import.meta.env?.BASE_URL || "/" } = {}) {
    ...
    this.trackMap = {
      "ode-to-joy": {
        id: "ode-to-joy",
        label: "Ode to Joy",
        source: this.resolveTrackSource("ode-to-joy-32bit.wav"),
        credit: "Ludwig van Beethoven",
      },
      "fur-elise": {
        id: "fur-elise",
        label: "Fur Elise",
        source: this.resolveTrackSource("fur-elise-32bit.wav"),
        credit: "Ludwig van Beethoven",
      },
      "minuet-in-g": {
        id: "minuet-in-g",
        label: "Minuet in G",
        source: this.resolveTrackSource("minuet-in-g-32bit.wav"),
        credit: "Christian Petzold / J.S. Bach notebook",
      },
      "twinkle-twinkle": {
        id: "twinkle-twinkle",
        label: "Twinkle, Twinkle",
        source: this.resolveTrackSource("twinkle-twinkle-32bit.wav"),
        credit: "Traditional",
      },
      "auld-lang-syne": {
        id: "auld-lang-syne",
        label: "Auld Lang Syne",
        source: this.resolveTrackSource("auld-lang-syne-32bit.wav"),
        credit: "Robert Burns / traditional",
      },
      "turkish-march": {
        id: "turkish-march",
        label: "Turkish March",
        source: this.resolveTrackSource("turkish-march-32bit.wav"),
